...
=================== + ================================================= + =============================================
help                | Prints help on screen                             | eblem> help              
'|' symbol          | Means 'or'                                        | eblem> click 1 | 2 means click 1 or 2  
'-' symbol          | Used for the short flag                           | eblem> john smith -g                   
'--' symbol         | Used for the long flag                            | eblem> john smith --google             
...
Options Short/Long  |  Description                                      |  Example                                 
=================== + ================================================= + =============================================
-c, --company       | Executes all available searches for companies     | eblem> glovdi -c | --company       
-d, --domain        | Executes all available searches for domains       | eblem> glovdi.com -d | --domain
-i, --individual    | Executes all available searches for individuals   | eblem> john smith -i | --individual
-i and -l           | As above including location of an individual      | eblem> john smith -i madrid -l
-e, --email         | Performs all possible searches using an email     | eblem> jsmith@email.com -e | --email

-- Note: The 2 following flags below are executed whenever the above ALL in ONE flags are executed. --  
-sm, --socialMedia  | Executes all available searches in social media   | eblem> john smith -sm | --socialMedia
-s, --search        | Executes all available searches in search engines | eblem> glovdi -s | --search
...
Options Short/Long  |  Description                                      |  Example                                 
=================== + ================================================= + =============================================
-rts, --rtsearch    | Returns real time social media search results     | eblem> john smith -rts | --rtsearch  
-fb, --facebook     | Performs facebook search through google           | eblem> john smith -fb | --facebook     
-ln, --linkedin     | Performs linkedin search through google           | eblem> john smith -ln | --linkedin     
-tw, --twitter      | Twitter search plus retrieves tweets and analytics| eblem> john smith -tw | --twitter      
-in, --instagram    | Performs instagram search, posts and analytics    | eblem> john smith -in | --instagram
-pn, --pinterest    | Performs pinterest search through google          | eblem> john smith -pn | --pinterest
-yt, --youtube      | Performs search in youtube for username           | eblem> john smith -yt | --youtube
-evs, --extraVid    | Perfroms further search in multiple video engines | eblem> john smith -evs | --extraVid
-tb, --tumblr       | Performs tumblr search through google             | eblem> john smith -tb | --tumblr    
-re, --redit        | Performs reddit search and posts search           | eblem> john smith -re | --reddit
-ure, --userReddit  | Provides insights and statistics on reddit user   | eblem> john smith -ure | --userReddit
-bl, --blogs        | Searches in blogs about target keyword            | eblem> john smith -bl | --blogs  
-cd ,--code         | Performs github & 'nerdy data' search on repos    | eblem> setoolkit -cd | --code
...
Options Short/Long  |  Description                                      |  Example                                 
=================== + ================================================= + =============================================
-g, --google        | Performs normal google search                     | eblem> john smith -g | --google      
-ddg, --ddGo        | Performs search in duck duck go search engine     | eblem> john smith -ddg | --ddGo
-bd, --baidu        | Performs search in chinese engine baidu           | eblem> john smith -bd | --baidu
-bg, --bing         | Performs search in bing search engine             | eblem> john smith -bg | --bing
-qw, --qwant        | Performs search in qwant search engine            | eblem> john smith -qw | --qwant
-km, --keyword      | Performs keyword matching search on given keyword | eblem> john smith -km | --keyword
-cl, --cluster      | Performs clustering search for query              | eblem> john smith -cl | --cluster 
-ex, --exciteNews   | Performs search about recent news on search engine| eblem> john smith -ex | --exciteNews
-oa, --oldArticles  | Performs search about very old posts about query  | eblem> john smith -oa | --oldArticles
-ev, --emailValid   | Performs email validity search for target mail    | eblem> jsmith@email.com -ev | --emailValid
-rss, --rssFeeds    | Performs RSS search in feeds on target keyword    | eblem> john smith -rss | --rssFeeds
...
Options Short/Long  |  Description                                      |  Example                                 
=================== + ================================================= + =============================================      
-p, --people        | Provides links on multiple people search engines  | eblem> john smith -p | --people          
-p and -l           | Performs specific pipl using with location        | eblem> john smith -p madrid -l         
...
Options Short/Long  |  Description                                      |  Example                                 
=================== + ================================================= + =============================================       
-cs, --compSearch   | Performs search in multiple companies websites    | eblem> glovdi -cs | compSearch             
-are, --reports     | Provides 2 links with annual reports of companies | eblem> glovdi -are | --reports
-cef, --emailFormat | Returns the email format of the company searched  | eblem> glovdi -cef | --emailFormat
...
Options Short/Long  |  Description                                      |  Example                                 
=================== + ================================================= + =============================================
-wh, --whois        | Performs whois search in the target domain        | eblem> glovdi.com -wh | --whois
-dns, --dnsLookup   | Performs a DNS lookup about target domain         | eblem> glovdi.com -dns | --dnsLookup     
-sc, --scan         | Performs a vulnerability scan using asafaweb site | eblem> glovdi.com -sc | --scan
-ar, --archive      | Performs search for past versions of website      | eblem> glovdi.com -ar | --arch
-bw, --builtWith    | Shows with which tools and tech the site is built | eblem> glovdi.com -bw | --builtWith
-rb, --robots       | Provides the link including the robots.txt file   | eblem> glovdi.com -rb | --robots     
...
2. In a terminal, run `python3 eblem.py`
